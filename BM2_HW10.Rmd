...
\begin{enumerate}
\item[1] The hazard ratio for subjects of age k in Stage II versus subjects in Stage I is $e^{-7.38+0.11\times k}$ holing age asconstant.
\item[2] The hazard ratio for subjects in Stage III versus subjects in Stage I is 1.86, keeping age at diagnosis constant.
\item[3] The hazard ratio for subjects in Stage IV versus subjects in Stage I is 5.77, keeping age at diagnosis constant.
\item[3] When the patients are not in stage II, the hazard ratio for one-year increase in age at diagnosis is 1.0059908, for patients in the same stage; if the patients are in stage II, the hazard ratio for one-year increase in age at diagnosis is 1.12.
\end{enumerate}
